...
SET 'state.checkpoints.dir' = '__CHECKPOINTS_DIR__/item-assignments-cdc';
...
CREATE TEMPORARY TABLE pg_osb_item_assignments (
  id STRING,
  ticket_id STRING,
  ticket_group_id STRING,
  selection_id STRING,
  ...
  'slot.name' = 'cdc_osb_item_assignments_to_fluss',
  'decoding.plugin.name' = 'pgoutput',
  'scan.incremental.snapshot.enabled' = 'true'
);

-- 4) Start the replication stream into Fluss
INSERT INTO item_assignments_staging
SELECT
    id,
    ticket_id,
    ticket_group_id,
